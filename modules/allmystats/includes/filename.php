...
*/
  ...
  define('FILENAME_DISPLAY_BAD_AGENTS', 'display_bads_agents.php');
  define('FILENAME_DISPLAY_BOTS', 'display_bots.php');
  define('FILENAME_GRAPH_DAY_HOURS', 'graph_day_hours.php');
  define('FILENAME_GRAPH_MONTH_DAYS', 'graph_month_days.php');
  define('FILENAME_GRAPH_YEAR_MONTHS', 'graph_year_months.php');
  define('FILENAME_DISPLAY_OS_BROWSER', 'display_os_browser.php');
  define('FILENAME_DISPLAY_FOOTER', 'display_footer.php');
  define('FILENAME_DISPLAY_HEADER', 'display_header.php');
  define('FILENAME_HISTORY_MONTH_LIST', 'history_month_list.php');
  define('FILENAME_INDEX_FRAME', 'index.php'); //annulation frame
  define('FILENAME_LOGIN', 'login.php');
  define('FILENAME_DO_LOGIN', 'do_login.php');
  ...
  define('FILENAME_ADMIN_HISTO_LOGING', 'admin_histo_loging.php');
  define('FILENAME_ADMIN_PASSW_TOOL', 'admin_passw_tool.php');
?>
